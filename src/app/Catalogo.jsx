...
function Catalogo() {
    ...
    // Filtrar por búsqueda y categoría + solo disponibles
    const filtrados = productos.filter((prod) => {
    const coincideBusqueda = prod.nombre
        .toLowerCase()
        .includes(search.toLowerCase());
    const coincideCategoria = filtro === "Todos" || prod.categoria === filtro;
    const disponible = prod.stock > 0; // ✅ sólo mostrar si hay stock
    ...
    const ordenados = [...filtrados].sort((a, b) => {
      switch (orden) {
        ...
        case "stock-asc":
          return a.stock - b.stock; // Menos stock primero
        case "stock-desc":
          return b.stock - a.stock; // Más stock primero
        default:
          return 0;
      }
    });
